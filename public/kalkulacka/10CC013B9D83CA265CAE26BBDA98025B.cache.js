...
function cv(g,f){var a,b,c,d,e;if(rt(dv)){qt(dv,'onChange('+f+')');}if(!av(g,g.a)|| !av(g,g.b)|| !av(g,g.c))return;a=em(kj(g.a));b=em(kj(g.b));c=em(kj(g.c));d=b*c;e=xt(d-a);d=xt(d);mj(g.d,ho(d));if(d<a){mj(g.e,'');Cj(g.e,'value-red');}else{mj(g.e,ho(e));Cj(g.e,'value-normal');}}
function Eu(){}
