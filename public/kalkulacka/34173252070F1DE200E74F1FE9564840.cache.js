...
function Bp(e){var a,b,c,d;if(kh('logger')!==null){e.a=Dh(new Bh());pe(kh('logger'),e.a);Ap(e,'enabling logger');}b=ze(new te(),'Odpov\u011B\u010F');c=ze(new te(),'Odpov\u011B\u010F');d=ze(new te(),'Odpov\u011B\u010F');Df(b,new np());Df(c,new qp());Df(d,new tp());if(kh('grid1-odpoved-button')!==null){Ap(e,'enabling grids');pe(kh('grid1-odpoved-button'),b);xh(kh('grid1-odpoved-default'),false);xh(kh('grid1-odpoved-text'),false);pe(kh('grid2-odpoved-button'),c);xh(kh('grid2-odpoved-default'),false);xh(kh('grid2-odpoved-text'),false);pe(kh('grid3-odpoved-button'),d);xh(kh('grid3-odpoved-default'),false);xh(kh('grid3-odpoved-text'),false);}if(kh('kalkulacka')!==null){Ap(e,'enabling calc');xh(kh('kalkulacka'),false);}if(kh('unchecked1')!==null){pe(kh('unchecked1'),ef(new bf(),'a'));pe(kh('unchecked2'),ef(new bf(),'b'));pe(kh('unchecked3'),ef(new bf(),'c'));pe(kh('unchecked4'),ef(new bf(),'d'));}if(kh('hint1-nadpis-default')!==null){Ap(e,'enabling hint1');xh(kh('hint1-nadpis-default'),false);xh(kh('hint1-text'),false);a=ze(new te(),'N\xE1pov\u011Bda');Df(a,new wp());pe(kh('hint1-button'),a);}}
function mp(){}
