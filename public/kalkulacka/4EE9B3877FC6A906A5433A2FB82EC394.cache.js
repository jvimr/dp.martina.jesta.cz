...
function ku(c,a,b){if(!Fu(this.a,a))oj(vb(c,17));}
function hu(){}
...
function mv(e,c){var a,b,d,f;if(xt(nv)){wt(nv,'onChange()');}if(qj(e.b)===null||eo(qj(e.b))<1){sj(e.c,'');return;}b=km(qj(e.b));if(qj(e.b)===null||eo(qj(e.b))<1){sj(e.c,'');return;}a=km(qj(e.a));f=Dm(b*a)/100.0;if(xt(nv)){wt(nv,'vysledek: ['+f+']');}d=no(f);sj(e.c,d);}
function dv(){}
...
function gv(b,a){if(xt(jv)){wt(jv,'check('+a+')');}if(a===null||qj(a)===null||eo(qj(a))<1)return false;return true;}
function iv(g,f){var a,b,c,d,e;if(xt(jv)){wt(jv,'onChange('+f+')');}if(!gv(g,g.a)|| !gv(g,g.b)|| !gv(g,g.c))return;a=km(qj(g.a));b=km(qj(g.b));c=km(qj(g.c));d=b*c;e=Dt(d-a);d=Dt(d);sj(g.d,no(d));if(d<a){sj(g.e,'');ck(g.e,'value-red');}else{sj(g.e,no(e));ck(g.e,'value-normal');}}
function ev(){}
