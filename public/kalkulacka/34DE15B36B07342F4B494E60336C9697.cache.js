...
function dk(){}
_=dk.prototype=new Af();_.eb=kk;_.tN=kv+'VerticalPanel';_.tI=31;function uk(b,a){b.a=pb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[4],null);return b;}
function vk(a,b){yk(a,b,a.b);}
function xk(b,c){var a;for(a=0;a<b.b;++a){if(b.a[a]===c){return a;}}return (-1);}
function yk(d,e,a){var b,c;if(a<0||a>d.b){throw new lm();}if(d.b==d.a.a){c=pb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[d.a.a*2],null);for(b=0;b<d.a.a;++b){qb(c,b,d.a[b]);}d.a=c;}++d.b;for(b=d.b-1;b>a;--b){qb(d.a,b,d.a[b-1]);}qb(d.a,a,e);}
