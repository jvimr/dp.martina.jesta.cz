...
_=co.prototype=new Di();_.tI=36;function so(d){var a,b,c;a=ve(new pe(),'Odpov\u011B\u010F');b=ve(new pe(),'Odpov\u011B\u010F');c=ve(new pe(),'Odpov\u011B\u010F');tf(a,new io());tf(b,new lo());tf(c,new oo());if(og('grid1-odpoved-button')!==null){le(og('grid1-odpoved-button'),a);zg(og('grid1-odpoved-default'),false);zg(og('grid1-odpoved-text'),false);le(og('grid2-odpoved-button'),b);zg(og('grid2-odpoved-default'),false);zg(og('grid2-odpoved-text'),false);le(og('grid3-odpoved-button'),c);zg(og('grid3-odpoved-default'),false);zg(og('grid3-odpoved-text'),false);}if(og('kalkulacka')!==null){zg(og('kalkulacka'),false);}if(og('unchecked1')!==null){le(og('unchecked1'),Be(new ye(),'a'));le(og('unchecked2'),Be(new ye(),'b'));le(og('unchecked3'),Be(new ye(),'c'));le(og('unchecked4'),Be(new ye(),'d'));}}
function ho(){}
