...
function hu(c,a,b){if(!Cu(this.a,a))ij(vb(c,17));}
function eu(){}
...
function jv(e,c){var a,b,d,f;if(ut(kv)){tt(kv,'onChange()');}if(kj(e.b)===null||ao(kj(e.b))<1){mj(e.c,'');return;}b=hm(kj(e.b));if(kj(e.b)===null||ao(kj(e.b))<1){mj(e.c,'');return;}a=hm(kj(e.a));f=Am(b*a)/100.0;if(ut(kv)){tt(kv,'vysledek: ['+f+']');}d=ko(f);mj(e.c,d);}
function av(){}
...
function dv(b,a){if(ut(gv)){tt(gv,'check('+a+')');}if(a===null||kj(a)===null||ao(kj(a))<1)return false;return true;}
function fv(g,f){var a,b,c,d,e;if(ut(gv)){tt(gv,'onChange('+f+')');}if(!dv(g,g.a)|| !dv(g,g.b)|| !dv(g,g.c))return;a=hm(kj(g.a));b=hm(kj(g.b));c=hm(kj(g.c));d=b*c;e=At(d-a);d=At(d);mj(g.d,ko(d));if(d<a){mj(g.e,'');Cj(g.e,'value-red');}else{mj(g.e,ko(e));Cj(g.e,'value-normal');}}
function bv(){}
