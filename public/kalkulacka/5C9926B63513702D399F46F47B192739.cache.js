...
function fv(g,f){var a,b,c,d,e;if(ut(gv)){tt(gv,'onChange('+f+')');}if(!dv(g,g.a)|| !dv(g,g.b)|| !dv(g,g.c))return;a=hm(kj(g.a));b=hm(kj(g.b));c=hm(kj(g.c));d=b*c;e=At(d-a);d=At(d);mj(g.d,ko(d));if(d<a){mj(g.e,'nelze!');}else{mj(g.e,ko(e));}}
function bv(){}
