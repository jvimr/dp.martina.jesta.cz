...
function bk(){}
_=bk.prototype=new Af();_.eb=hk;_.tN=Bu+'VerticalPanel';_.tI=31;function rk(b,a){b.a=pb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[4],null);return b;}
function sk(a,b){vk(a,b,a.b);}
function uk(b,c){var a;for(a=0;a<b.b;++a){if(b.a[a]===c){return a;}}return (-1);}
function vk(d,e,a){var b,c;if(a<0||a>d.b){throw new im();}if(d.b==d.a.a){c=pb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[d.a.a*2],null);for(b=0;b<d.a.a;++b){qb(c,b,d.a[b]);}d.a=c;}++d.b;for(b=d.b-1;b>a;--b){qb(d.a,b,d.a[b-1]);}qb(d.a,a,e);}
