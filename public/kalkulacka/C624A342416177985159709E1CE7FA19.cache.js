...
function wp(e){var a,b,c,d;if(jh('logger')!==null){e.a=Ch(new Ah());oe(jh('logger'),e.a);vp(e,'enabling logger');}b=ye(new se(),'Odpov\u011B\u010F');c=ye(new se(),'Odpov\u011B\u010F');d=ye(new se(),'Odpov\u011B\u010F');Cf(b,new ip());Cf(c,new lp());Cf(d,new op());if(jh('grid1-odpoved-button')!==null){vp(e,'enabling grids');oe(jh('grid1-odpoved-button'),b);wh(jh('grid1-odpoved-default'),false);wh(jh('grid1-odpoved-text'),false);oe(jh('grid2-odpoved-button'),c);wh(jh('grid2-odpoved-default'),false);wh(jh('grid2-odpoved-text'),false);oe(jh('grid3-odpoved-button'),d);wh(jh('grid3-odpoved-default'),false);wh(jh('grid3-odpoved-text'),false);}if(jh('kalkulacka')!==null){vp(e,'enabling calc');wh(jh('kalkulacka'),false);}if(jh('unchecked1')!==null){oe(jh('unchecked1'),df(new af(),'a'));oe(jh('unchecked2'),df(new af(),'b'));oe(jh('unchecked3'),df(new af(),'c'));oe(jh('unchecked4'),df(new af(),'d'));}if(jh('hint1-nadpis-default')!==null){vp(e,'enabling hint1');wh(jh('hint1-nadpis-default'),false);wh(jh('hint1-text'),false);a=ye(new se(),'N\xE1pov\u011Bda');Cf(a,new rp());oe(jh('hint1-button'),a);}}
function hp(){}
