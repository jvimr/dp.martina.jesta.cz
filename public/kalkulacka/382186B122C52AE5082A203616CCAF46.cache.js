...
_=Dn.prototype=new yi();_.tI=36;function no(d){var a,b,c;a=ue(new oe(),'Odpov\u011B\u010F');b=ue(new oe(),'Odpov\u011B\u010F');c=ue(new oe(),'Odpov\u011B\u010F');sf(a,new co());sf(b,new go());sf(c,new jo());if(ng('grid1-odpoved-button')!==null){ke(ng('grid1-odpoved-button'),a);yg(ng('grid1-odpoved-default'),false);yg(ng('grid1-odpoved-text'),false);ke(ng('grid2-odpoved-button'),b);yg(ng('grid2-odpoved-default'),false);yg(ng('grid2-odpoved-text'),false);ke(ng('grid3-odpoved-button'),c);yg(ng('grid3-odpoved-default'),false);yg(ng('grid3-odpoved-text'),false);}if(ng('kalkulacka')!==null){yg(ng('kalkulacka'),false);}if(ng('unchecked1')!==null){ke(ng('unchecked1'),Ae(new xe(),'a'));ke(ng('unchecked2'),Ae(new xe(),'b'));ke(ng('unchecked3'),Ae(new xe(),'c'));ke(ng('unchecked4'),Ae(new xe(),'d'));}}
function bo(){}
