...
function iv(g,f){var a,b,c,d,e;if(xt(jv)){wt(jv,'onChange('+f+')');}if(!gv(g,g.a)|| !gv(g,g.b)|| !gv(g,g.c))return;a=km(qj(g.a));b=km(qj(g.b));c=km(qj(g.c));d=b*c;e=Dt(d-a);d=Dt(d);sj(g.d,no(d));if(d<a){sj(g.e,'nelze!');}else{sj(g.e,no(e));}}
function ev(){}
