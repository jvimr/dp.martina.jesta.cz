...
function ku(l,h){var a,b,c,d,e,f,g,i,j,k,m,n;if(rt(qu)){qt(qu,'DoPerCentCalc()');}i=pj(new ej());rj(i,6);j=pj(new ej());rj(j,5);k=pj(new ej());lj(k,true);rj(k,8);n=yu(new ru(),j,i,k);Dj(j,896);Dj(i,896);hj(j,Et(new Dt(),l));hj(i,cu(new bu(),l));g=fk(new dk());jk(g,(bh(),dh));a=ph(new nh());th(a,(bh(),dh));qh(a,yg(new vg(),'\u010C\xE1stka:&nbsp;',false));qh(a,i);qh(a,yg(new vg(),'&nbsp;K\u010D',false));gk(g,a);b=ph(new nh());th(b,(bh(),dh));qh(b,yg(new vg(),'Po\u010Det&nbsp;procent (\xFArok)&nbsp;:',false));qh(b,j);qh(b,yg(new vg(),'&nbsp;%',false));gk(g,b);d=ph(new nh());qh(d,yg(new vg(),'V\xFDsledek:&nbsp;',false));qh(d,k);qh(d,yg(new vg(),'&nbsp;K\u010D   ',false));m=xf(new rf(),'Vypo\u010Dti');m.j(gu(new fu(),l,n));c=ph(new nh());e=gi(new ei(),'               ');Cj(e,'50px');qh(c,e);qh(c,m);gk(g,c);f=gi(new ei(),'               ');Cj(f,'50px');gk(g,f);gk(g,d);nf(h,g);}
