...
function dv(e,c){var a,b,d,f;if(ot(ev)){nt(ev,'onChange()');}if(oj(e.b)===null||An(oj(e.b))<1){qj(e.c,'');return;}b=bm(oj(e.b));if(oj(e.b)===null||An(oj(e.b))<1){qj(e.c,'');return;}a=bm(oj(e.a));f=um(b*a)/100.0;if(ot(ev)){nt(ev,'vysledek: ['+f+']');}d=eo(f);qj(e.c,d);}
function Au(){}
...
function Du(b,a){if(ot(av)){nt(av,'check('+a+')');}if(a===null||oj(a)===null||An(oj(a))<1)return false;return true;}
function Fu(g,f){var a,b,c,d,e;if(ot(av)){nt(av,'onChange('+f+')');}if(!Du(g,g.a)|| !Du(g,g.b)|| !Du(g,g.c))return;a=bm(oj(g.a));b=bm(oj(g.b));c=bm(oj(g.c));d=b*c;e=ut(d-a);d=ut(d);qj(g.d,eo(d));if(d<a){qj(g.e,'nelze!');}else{qj(g.e,eo(e));}}
function Bu(){}
