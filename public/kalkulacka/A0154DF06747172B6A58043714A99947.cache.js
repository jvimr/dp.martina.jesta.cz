...
function jk(){}
_=jk.prototype=new ag();_.eb=qk;_.tN=qv+'VerticalPanel';_.tI=31;function Ak(b,a){b.a=pb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[4],null);return b;}
function Bk(a,b){Ek(a,b,a.b);}
function Dk(b,c){var a;for(a=0;a<b.b;++a){if(b.a[a]===c){return a;}}return (-1);}
function Ek(d,e,a){var b,c;if(a<0||a>d.b){throw new rm();}if(d.b==d.a.a){c=pb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[d.a.a*2],null);for(b=0;b<d.a.a;++b){qb(c,b,d.a[b]);}d.a=c;}++d.b;for(b=d.b-1;b>a;--b){qb(d.a,b,d.a[b-1]);}qb(d.a,a,e);}
