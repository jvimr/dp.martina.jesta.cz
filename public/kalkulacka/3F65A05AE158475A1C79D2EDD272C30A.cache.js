...
function bv(e,c){var a,b,d,f;if(mt(cv)){lt(cv,'onChange()');}if(e.b===null||jj(e.b)===null||yn(Bn(jj(e.b)))<1){lj(e.c,'');return;}b=Fl(Bn(jj(e.b)));if(e.a===null||jj(e.a)===null||yn(Bn(jj(e.a)))<1){lj(e.c,'');return;}a=Fl(Bn(jj(e.a)));f=sm(b*a)/100.0;if(mt(cv)){lt(cv,'vysledek: ['+f+']');}d=bo(f);lj(e.c,d);}
function yu(){}
...
function Bu(b,a){if(mt(Eu)){lt(Eu,'check('+a+')');}if(a===null||jj(a)===null||yn(Bn(jj(a)))<1)return false;return true;}
function Du(g,f){var a,b,c,d,e;if(mt(Eu)){lt(Eu,'onChange('+f+')');}if(!Bu(g,g.a)|| !Bu(g,g.b)|| !Bu(g,g.c)){if(g.d!==null)lj(g.d,'');if(g.e!==null)lj(g.e,'');return;}a=Fl(jj(g.a));b=Fl(jj(g.b));c=Fl(jj(g.c));d=b*c;e=st(d-a);d=st(d);lj(g.d,bo(d));if(d<a){lj(g.e,'nelze!');}else{lj(g.e,bo(e));}}
function zu(){}
