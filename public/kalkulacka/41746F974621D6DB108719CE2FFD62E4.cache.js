...
function Ft(c,a,b){if(!uu(this.a,a))hj(vb(c,17));}
function Ct(){}
...
function Du(g,f){var a,b,c,d,e;if(mt(Eu)){lt(Eu,'onChange('+f+')');}if(!Bu(g,g.a)|| !Bu(g,g.b)|| !Bu(g,g.c))return;a=Fl(jj(g.a));b=Fl(jj(g.b));c=Fl(jj(g.c));d=b*c;e=st(d-a);d=st(d);lj(g.d,bo(d));if(d<a){lj(g.e,'');Bj(g.e,'value-red');}else{lj(g.e,bo(e));Bj(g.e,'value-normal');}}
function zu(){}
