...
function Ah(){}
_=Ah.prototype=new Be();_.E=ai;_.tI=27;function ki(b,a){b.a=fb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[8],[4],null);return b;}
function li(a,b){oi(a,b,a.b);}
function ni(b,c){var a;for(a=0;a<b.b;++a){if(b.a[a]===c){return a;}}return (-1);}
function oi(d,e,a){var b,c;if(a<0||a>d.b){throw new uj();}if(d.b==d.a.a){c=fb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[8],[d.a.a*2],null);for(b=0;b<d.a.a;++b){gb(c,b,d.a[b]);}d.a=c;}++d.b;for(b=d.b-1;b>a;--b){gb(d.a,b,d.a[b-1]);}gb(d.a,a,e);}
...
function aq(i,c){var a,b,d,e,f,g,h;if(jh('q'+c+'-unchecked1')!==null){b=up(new tp(),i,c);d=Fg(new Eg(),'q'+c);zf(d,b);oe(jh('q'+c+'-unchecked1'),d);if(jh('q'+c+'-unchecked2')!==null){e=Fg(new Eg(),'q'+c);zf(e,b);oe(jh('q'+c+'-unchecked2'),e);}if(jh('q'+c+'-unchecked3')!==null){f=Fg(new Eg(),'q'+c);zf(f,b);oe(jh('q'+c+'-unchecked3'),f);}if(jh('q'+c+'-unchecked4')!==null){g=Fg(new Eg(),'q'+c);zf(g,b);oe(jh('q'+c+'-unchecked4'),g);}if(jh('q'+c+'-unchecked5')!==null){h=Fg(new Eg(),'q'+c);zf(h,b);oe(jh('q'+c+'-unchecked5'),h);}if(jh('q'+c+'-unchecked6')!==null){h=Fg(new Eg(),'q'+c);zf(h,b);oe(jh('q'+c+'-unchecked6'),h);}wh(jh('q'+c+'-correct'),false);wh(jh('q'+c+'-incorrect'),false);a=Fg(new Eg(),'q'+c);zf(a,yp(new xp(),i,c));oe(jh('q'+c+'-checked1'),a);}}
function hp(){}
