...
function eq(b){var a;if(kh('logger')!==null){b.a=Dh(new Bh());pe(kh('logger'),b.a);dq(b,'enabling logger');}bq(b,'1');bq(b,'2');bq(b,'3');bq(b,'4');bq(b,'5');bq(b,'6');if(kh('kalkulacka')!==null){dq(b,'enabling calc');xh(kh('kalkulacka'),false);a=ze(new te(),'Kalkula\u010Dka');Af(a,new rp());if(kh('kalkulacka-button')!==null){pe(kh('kalkulacka-button'),a);}}fq(b,'1');fq(b,'2');fq(b,'3');fq(b,'4');cq(b,'1');cq(b,'2');cq(b,'4');}
function fq(i,c){var a,b,d,e,f,g,h;if(kh('q'+c+'-unchecked1')!==null){b=zp(new yp(),i,c);d=ah(new Fg(),'q'+c);Af(d,b);pe(kh('q'+c+'-unchecked1'),d);if(kh('q'+c+'-unchecked2')!==null){e=ah(new Fg(),'q'+c);Af(e,b);pe(kh('q'+c+'-unchecked2'),e);}if(kh('q'+c+'-unchecked3')!==null){f=ah(new Fg(),'q'+c);Af(f,b);pe(kh('q'+c+'-unchecked3'),f);}if(kh('q'+c+'-unchecked4')!==null){g=ah(new Fg(),'q'+c);Af(g,b);pe(kh('q'+c+'-unchecked4'),g);}if(kh('q'+c+'-unchecked5')!==null){h=ah(new Fg(),'q'+c);Af(h,b);pe(kh('q'+c+'-unchecked5'),h);}if(kh('q'+c+'-unchecked6')!==null){h=ah(new Fg(),'q'+c);Af(h,b);pe(kh('q'+c+'-unchecked6'),h);}xh(kh('q'+c+'-correct'),false);if(kh('q'+c+'-correct-1')!==null)xh(kh('q'+c+'-correct-1'),false);xh(kh('q'+c+'-incorrect'),false);a=ah(new Fg(),'q'+c);Af(a,Dp(new Cp(),i,c));pe(kh('q'+c+'-checked1'),a);}}
function mp(){}
...
function Bp(a){xh(kh('q'+this.a+'-incorrect'),true);xh(kh('q'+this.a+'-correct'),false);}
function yp(){}
_=yp.prototype=new Ej();_.y=Bp;_.tI=44;function Dp(b,a,c){b.a=c;return b;}
function Fp(a){xh(kh('q'+this.a+'-correct'),true);if(kh('q'+this.a+'-correct-1')!==null)xh(kh('q'+this.a+'-correct-1'),true);xh(kh('q'+this.a+'-incorrect'),false);}
function Cp(){}
