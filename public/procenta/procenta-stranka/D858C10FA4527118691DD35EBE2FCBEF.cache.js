...
function Fp(b){var a;if(jh('logger')!==null){b.a=Ch(new Ah());oe(jh('logger'),b.a);Ep(b,'enabling logger');}Cp(b,'1');Cp(b,'2');Cp(b,'3');Cp(b,'4');Cp(b,'5');Cp(b,'6');if(jh('kalkulacka')!==null){Ep(b,'enabling calc');wh(jh('kalkulacka'),false);a=ye(new se(),'Kalkula\u010Dka');zf(a,new mp());if(jh('kalkulacka-button')!==null){oe(jh('kalkulacka-button'),a);}}aq(b,'1');aq(b,'2');aq(b,'3');aq(b,'4');Dp(b,'1');Dp(b,'2');Dp(b,'4');}
function aq(i,c){var a,b,d,e,f,g,h;if(jh('q'+c+'-unchecked1')!==null){b=up(new tp(),i,c);d=Fg(new Eg(),'q'+c);zf(d,b);oe(jh('q'+c+'-unchecked1'),d);if(jh('q'+c+'-unchecked2')!==null){e=Fg(new Eg(),'q'+c);zf(e,b);oe(jh('q'+c+'-unchecked2'),e);}if(jh('q'+c+'-unchecked3')!==null){f=Fg(new Eg(),'q'+c);zf(f,b);oe(jh('q'+c+'-unchecked3'),f);}if(jh('q'+c+'-unchecked4')!==null){g=Fg(new Eg(),'q'+c);zf(g,b);oe(jh('q'+c+'-unchecked4'),g);}if(jh('q'+c+'-unchecked5')!==null){h=Fg(new Eg(),'q'+c);zf(h,b);oe(jh('q'+c+'-unchecked5'),h);}if(jh('q'+c+'-unchecked6')!==null){h=Fg(new Eg(),'q'+c);zf(h,b);oe(jh('q'+c+'-unchecked6'),h);}wh(jh('q'+c+'-correct'),false);if(jh('q'+c+'-correct-1')!==null)wh(jh('q'+c+'-correct-1'),false);wh(jh('q'+c+'-incorrect'),false);a=Fg(new Eg(),'q'+c);zf(a,yp(new xp(),i,c));oe(jh('q'+c+'-checked1'),a);}}
function hp(){}
...
function Ap(a){wh(jh('q'+this.a+'-correct'),true);if(jh('q'+this.a+'-correct-1')!==null)wh(jh('q'+this.a+'-correct-1'),true);wh(jh('q'+this.a+'-incorrect'),false);}
function xp(){}
