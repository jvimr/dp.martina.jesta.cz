...
function cq(i,c){var a,b,d,e,f,g,h;if(oh('q'+c+'-unchecked1')!==null){b=wp(new vp(),i,c);d=eh(new dh(),'q1');Ef(d,b);te(oh('q'+c+'-unchecked1'),d);if(oh('q'+c+'-unchecked2')!==null){e=eh(new dh(),'q1');Ef(e,b);te(oh('q'+c+'-unchecked2'),e);}if(oh('q'+c+'-unchecked3')!==null){f=eh(new dh(),'q1');Ef(f,b);te(oh('q'+c+'-unchecked3'),f);}if(oh('q'+c+'-unchecked4')!==null){g=eh(new dh(),'q1');Ef(g,b);te(oh('q'+c+'-unchecked4'),g);}if(oh('q'+c+'-unchecked5')!==null){h=eh(new dh(),'q1');Ef(h,b);te(oh('q'+c+'-unchecked5'),h);}if(oh('q'+c+'-unchecked6')!==null){h=eh(new dh(),'q1');Ef(h,b);te(oh('q'+c+'-unchecked6'),h);}Bh(oh('q'+c+'-correct'),false);Bh(oh('q'+c+'-incorrect'),false);a=eh(new dh(),'q'+c+'');Ef(a,Ap(new zp(),i,c));te(oh('q'+c+'-checked1'),a);}}
function jp(){}
...
function yp(a){Bh(oh('q'+this.a+'-incorrect'),true);Bh(oh('q'+this.a+'-correct'),false);}
function vp(){}
_=vp.prototype=new Bj();_.y=yp;_.tI=44;function Ap(b,a,c){b.a=c;return b;}
function Cp(a){Bh(oh('q'+this.a+'-correct'),true);Bh(oh('q'+this.a+'-incorrect'),false);}
function zp(){}
