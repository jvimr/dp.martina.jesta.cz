...
function hq(b){var a;if(kh('logger')!==null){b.a=Dh(new Bh());pe(kh('logger'),b.a);gq(b,'enabling logger');}eq(b,'1');eq(b,'2');eq(b,'3');eq(b,'4');eq(b,'5');eq(b,'6');if(kh('kalkulacka')!==null){gq(b,'enabling calc');xh(kh('kalkulacka'),false);a=ze(new te(),'Kalkula\u010Dka');Af(a,new up());if(kh('kalkulacka-button')!==null){pe(kh('kalkulacka-button'),a);}}iq(b,'1');iq(b,'2');iq(b,'3');iq(b,'4');fq(b,'1');fq(b,'2');fq(b,'4');}
