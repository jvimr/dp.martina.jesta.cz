...
function iq(i,c){var a,b,d,e,f,g,h;if(kh('q'+c+'-unchecked1')!==null){b=Cp(new Bp(),i,c);d=ah(new Fg(),'q'+c);Af(d,b);pe(kh('q'+c+'-unchecked1'),d);if(kh('q'+c+'-unchecked2')!==null){e=ah(new Fg(),'q'+c);Af(e,b);pe(kh('q'+c+'-unchecked2'),e);}if(kh('q'+c+'-unchecked3')!==null){f=ah(new Fg(),'q'+c);Af(f,b);pe(kh('q'+c+'-unchecked3'),f);}if(kh('q'+c+'-unchecked4')!==null){g=ah(new Fg(),'q'+c);Af(g,b);pe(kh('q'+c+'-unchecked4'),g);}if(kh('q'+c+'-unchecked5')!==null){h=ah(new Fg(),'q'+c);Af(h,b);pe(kh('q'+c+'-unchecked5'),h);}if(kh('q'+c+'-unchecked6')!==null){h=ah(new Fg(),'q'+c);Af(h,b);pe(kh('q'+c+'-unchecked6'),h);}xh(kh('q'+c+'-correct'),false);if(kh('q'+c+'-correct-1')!==null)xh(kh('q'+c+'-correct-1'),false);xh(kh('q'+c+'-incorrect'),false);a=ah(new Fg(),'q'+c);Af(a,aq(new Fp(),i,c));pe(kh('q'+c+'-checked1'),a);}}
function pp(){}
...
function Ep(a){xh(kh('q'+this.a+'-incorrect'),true);xh(kh('q'+this.a+'-correct'),false);if(kh('q'+this.a+'-correct-1')!==null)xh(kh('q'+this.a+'-correct-1'),false);}
function Bp(){}
_=Bp.prototype=new bk();_.y=Ep;_.tI=44;function aq(b,a,c){b.a=c;return b;}
function cq(a){xh(kh('q'+this.a+'-correct'),true);if(kh('q'+this.a+'-correct-1')!==null)xh(kh('q'+this.a+'-correct-1'),true);xh(kh('q'+this.a+'-incorrect'),false);}
function Fp(){}
