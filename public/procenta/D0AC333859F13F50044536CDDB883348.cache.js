...
function op(){}
_=op.prototype=new Ej();_.y=rp;_.tI=42;function wp(a){Bh(oh('grid2-odpoved-text'),true);Bh(oh('grid2-odpoved-button'),false);}
function up(){}
_=up.prototype=new Ej();_.y=wp;_.tI=43;function zp(a){Bh(oh('grid3-odpoved-text'),true);Bh(oh('grid3-odpoved-button'),false);}
function xp(){}
_=xp.prototype=new Ej();_.y=zp;_.tI=44;function Cp(a){Bh(oh('kalkulacka'),true);Bh(oh('kalkulacka-button'),false);}
function Ap(){}
