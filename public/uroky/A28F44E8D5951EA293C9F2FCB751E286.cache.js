...
function ji(){}
_=ji.prototype=new ki();_.tI=29;function ij(b,a){b.b=a;b.a=mb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[4],null);return b;}
function jj(a,b){mj(a,b,a.c);}
function lj(b,c){var a;for(a=0;a<b.c;++a){if(b.a[a]===c){return a;}}return (-1);}
function mj(d,e,a){var b,c;if(a<0||a>d.c){throw new Fk();}if(d.c==d.a.a){c=mb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[d.a.a*2],null);for(b=0;b<d.a.a;++b){ob(c,b,d.a[b]);}d.a=c;}++d.c;for(b=d.c-1;b>a;--b){ob(d.a,b,d.a[b-1]);}ob(d.a,a,e);}
...
function ur(j){var a,c,d,e,f,g,h,i,k,l,m,n;f='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED ';g=' K\u010D a to je o ';h=' K\u010D ( o ';i=' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';c='???';d=0;if(lh(j.c)>0){d=j.b[lh(j.c)-1];c=im(d);}else{return;}l=0.0;if(pi(j.d)!==null&&Fl(pi(j.d))>0){m=cm(pi(j.d));m=am(m,44,46);try{l=vk(m);}catch(a){a=Cb(a);if(tb(a,17)){a;qi(j.d,'13.5');return;}else throw a;}}l=hl(l*100)/10000.0;if(l<=0.0){return;}if(l>10000){qi(j.d,'13.5');return;}k=l*d;n=k+d;qi(j.d,hm(l*100));e='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED '+hm(n)+' K\u010D a to je o '+hm(k)+' K\u010D ( o '+hm(l*100)+' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';if(ai('q3_ans')!==null){rh(ai('q3_ans'));df(ai('q3_ans'),jg(new gg(),e,false));}Ai(ai('q3_ans'),true);}
function ir(){}
