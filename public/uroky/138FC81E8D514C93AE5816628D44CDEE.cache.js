...
function rr(j){var a,c,d,e,f,g,h,i,k,l,m,n;f='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED <b>';g='<\/b> K\u010D a to je o <b>';h='<\/b> K\u010D (o ';i=' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';c='???';d=0;if(ph(j.c)>0){d=j.b[ph(j.c)-1];c=fm(d);}else{return;}l=0.0;if(ti(j.d)!==null&&Cl(ti(j.d))>0){m=Fl(ti(j.d));m=Dl(m,44,46);try{l=sk(m);}catch(a){a=Cb(a);if(tb(a,17)){a;ui(j.d,'13.5');return;}else throw a;}}if(el(l)!=l){l=el(l*100.0)/100.0;}else{}if(l<=0.0){return;}if(l>10000){ui(j.d,'13.5');return;}k=el(l*d*100)/10000.0;n=k+d;ui(j.d,em(l));e='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED <b>'+em(n)+'<\/b> K\u010D a to je o <b>'+em(k)+'<\/b> K\u010D (o '+em(l)+' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';if(ei('q3_ans')!==null){vh(ei('q3_ans'));hf(ei('q3_ans'),ng(new kg(),e,true));}Ei(ei('q3_ans'),true);}
function fr(){}
