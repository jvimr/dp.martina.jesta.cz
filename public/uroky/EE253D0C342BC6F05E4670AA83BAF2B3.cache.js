...
function Ar(j){var a,c,d,e,f,g,h,i,k,l,m,n;f='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED <b>';g='<\/b> K\u010D a to je o <b>';h='<\/b> K\u010D (o ';i=' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';c='???';d=0;if(rh(j.c)>0){d=j.b[rh(j.c)-1];c=om(d);}else{return;}l=0.0;if(vi(j.d)!==null&&fm(vi(j.d))>0){m=im(vi(j.d));m=gm(m,44,46);try{l=Bk(m);}catch(a){a=Cb(a);if(tb(a,17)){a;wi(j.d,'13.5');return;}else throw a;}}if(nl(l)!=l){l=nl(l*100.0)/100.0;}else{}if(l<=0.0){return;}if(l>10000){wi(j.d,'13.5');return;}k=l*d/100.0;n=k+d;wi(j.d,nm(l));e='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED <b>'+nm(n)+'<\/b> K\u010D a to je o <b>'+nm(k)+'<\/b> K\u010D (o '+nm(l)+' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';if(gi('q3_ans')!==null){xh(gi('q3_ans'));kf(gi('q3_ans'),pg(new mg(),e,true));}aj(gi('q3_ans'),true);}
function or(){}
