...
function xr(j){var a,c,d,e,f,g,h,i,k,l,m,n;f='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED <b>';g='<\/b> K\u010D a to je o <b>';h='<\/b> K\u010D (o ';i=' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';c='???';d=0;if(lh(j.c)>0){d=j.b[lh(j.c)-1];c=lm(d);}else{return;}l=0.0;if(pi(j.d)!==null&&cm(pi(j.d))>0){m=fm(pi(j.d));m=dm(m,44,46);try{l=yk(m);}catch(a){a=Cb(a);if(tb(a,17)){a;qi(j.d,'13.5');return;}else throw a;}}if(kl(l)!=l){l=kl(l*100.0)/100.0;}else{}if(l<=0.0){return;}if(l>10000){qi(j.d,'13.5');return;}k=l*d/100.0;n=k+d;qi(j.d,km(l));e='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED <b>'+km(n)+'<\/b> K\u010D a to je o <b>'+km(k)+'<\/b> K\u010D (o '+km(l)+' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';if(ai('q3_ans')!==null){rh(ai('q3_ans'));df(ai('q3_ans'),jg(new gg(),e,true));}Ai(ai('q3_ans'),true);}
function lr(){}
