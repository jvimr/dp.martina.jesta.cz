...
function pi(){}
_=pi.prototype=new qi();_.tI=29;function oj(b,a){b.b=a;b.a=mb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[4],null);return b;}
function pj(a,b){sj(a,b,a.c);}
function rj(b,c){var a;for(a=0;a<b.c;++a){if(b.a[a]===c){return a;}}return (-1);}
function sj(d,e,a){var b,c;if(a<0||a>d.c){throw new fl();}if(d.c==d.a.a){c=mb('[Lcom.google.gwt.user.client.ui.Widget;',[0],[9],[d.a.a*2],null);for(b=0;b<d.a.a;++b){ob(c,b,d.a[b]);}d.a=c;}++d.c;for(b=d.c-1;b>a;--b){ob(d.a,b,d.a[b-1]);}ob(d.a,a,e);}
...
function Ar(j){var a,c,d,e,f,g,h,i,k,l,m,n;f='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED ';g=' K\u010D a to je o ';h=' K\u010D (o ';i=' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';c='???';d=0;if(rh(j.c)>0){d=j.b[rh(j.c)-1];c=om(d);}else{return;}l=0.0;if(vi(j.d)!==null&&fm(vi(j.d))>0){m=im(vi(j.d));m=gm(m,44,46);try{l=Bk(m);}catch(a){a=Cb(a);if(tb(a,17)){a;wi(j.d,'13.5');return;}else throw a;}}if(nl(l)!=l){l=nl(l*100)/10000.0;}else{l=l/100.0;}if(l<=0.0){return;}if(l>10000){wi(j.d,'13.5');return;}k=l*d;n=k+d;wi(j.d,nm(l*100));e='\u010C\xE1stka, kterou byste m\u011Bli po roce zaplatit bance, \u010Din\xED '+nm(n)+' K\u010D a to je o '+nm(k)+' K\u010D (o '+nm(l*100)+' %) v\xEDc ne\u017E p\u016Fvodn\xED \u010D\xE1stka.';if(gi('q3_ans')!==null){xh(gi('q3_ans'));kf(gi('q3_ans'),pg(new mg(),e,true));}aj(gi('q3_ans'),true);}
function or(){}
